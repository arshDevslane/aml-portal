...
const GridQuestion = forwardRef(
  ({ question, onSubmit }: GridQuestionProps, ref) => {
      ...
      topAnswer: Yup.array()
        ...
        .test(
          ...
          function (value) {
            ...
            return questionType !== 'grid-1' || (value && value.length > 0);
          }
        ),
    ...
    const formik = useFormik<FormValues>({
      ...
      onSubmit: (values) => {
        ...
        } else if (question.questionType === 'grid-2') {
          onSubmit({
        ...
        {question.questionType === 'fib' && (
          <div className='flex flex-row items-center justify-center relative'>
            <p className='text-4xl font-semibold text-headingTextColor ml-[60px] pt-[23px] pb-[22px] px-[7px]'>
              {question?.numbers.n1} + {question?.numbers.n2} =
            </p>
